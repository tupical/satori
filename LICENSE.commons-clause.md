...
- You may **not** offer Satori (or a derivative whose value derives
  substantially from Satori) as a paid product or paid hosted/managed
  service to third parties without a commercial licence from the
  Licensor.
- Bundling Satori into a larger product whose paid value clearly
  derives from other components is permitted, as long as the Satori
  portion itself is not the substantial source of paid value.

If you want to sell Satori as a service or product, contact the
